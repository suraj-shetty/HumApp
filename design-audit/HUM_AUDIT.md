...
>
> **50 findings, across 18 changes, are fixed since this report was written — plus four new screens built (below).**
>
...
~~01 Splash~~ · ~~02–03 Onboarding (×2)~~ · 09 Home-loading · 11 Home-offline · 15 Search-error · 18 Library-sync-error · 20 Playlist-loading · 22 Artist detail · 24 Now Playing-buffering · 25 Track unavailable · 29 Full-screen error · ~~31 Track context menu~~ · 32 Add to playlist · 33 Search-focused/recents · 34 Now Playing-lyrics · 35 AirPlay picker (already answered by the system's own `AVRoutePickerView`, wired since the NP-8 fix — see §8.2's NP-11) · 36 Playlist-empty · 37 Detail-failed · 39–41 Settings sub-screens · 42 New playlist
